...
<!-- JSPL을 쓰기위한 거 ---jspl은 톰켓거임!!!! 톰켓사이트 왼쪽베뉴 다운로드 에 가면 태그가있음 -->
	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				<!-- 조건문 test에 조건을 넣는다. empty는 공백인지 널인지 같이체크 !=null는 널만 비교 -->
				<c:choose>
					...
					<c:otherwise>
						...
						<li class="nav-item"><a class="nav-link" href="/user?cmd=updateForm">회원정보수정</a></li>
